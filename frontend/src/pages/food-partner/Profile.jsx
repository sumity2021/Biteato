      ...
      <section className="profile-header">
        <div className="profile-meta">
          ...
          <div className="profile-info">
            <h1 className="profile-pill " title="Business name">
              {profile?.name}
            </h1>
            <p className="profile-pill " title="Contact">
              {profile?.contactName}
            </p>
            <p className="profile-pill " title="Phone">
              {profile?.phone}
            </p>
            <p className="profile-pill " title="Address">
              {profile?.address}
            </p>
          </div>
        </div>
